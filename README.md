...
[![R build status](https://github.com/extendr/hellopolars/workflows/R-CMD-check/badge.svg)](https://github.com/extendr/hellopolars/actions)
...
```r
remotes::install_github("extendr/hellopolars")
```
